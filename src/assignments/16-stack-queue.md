...
- [easy.lectures.14-recursion.code.src.com.lectures.06-conditions-loops.code.src.com.Reverse First K elements of Queue](https://practice.geeksforgeeks.org/problems/reverse-first-k-elements-of-queue/1/) `GFG`
...
## Medium
- [Design a Stack With Increment generics.lectures.17-oop.code.src.com.Operation](https://leetcode.com/problems/design-a-stack-with-increment-operation/) `leetcode`
...
- [arrays.lectures.14-recursion.code.src.com.Find the Most Competitive Subsequence](https://leetcode.com/problems/find-the-most-competitive-subsequence/) `leetcode`
...
- [lectures.08-arrays.code.src.com.Max Rectangle](https://practice.geeksforgeeks.org/problems/max-rectangle/1/) `GFG`

...
## Easy
- [easy.lectures.14-recursion.code.src.com.lectures.07-methods.code.src.com.lectures.05-first-java-program.first-idea-program.src.com.Sum polymorphism.properties.lectures.17-oop.code.src.com.patterns.lectures.14-recursion.code.src.com.Triangle from Array](https://www.geeksforgeeks.org/sum-triangle-from-array/) `GFG`
...
- [easy.lectures.14-recursion.code.src.com.lectures.06-conditions-loops.code.src.com.Reverse String](https://leetcode.com/problems/reverse-string/) `leetcode`
...
- [easy.lectures.14-recursion.code.src.com.lectures.07-methods.code.src.com.lectures.05-first-java-program.first-idea-program.src.com.Sum of digit of a number using Recursion](https://www.geeksforgeeks.org/sum-digit-number-using-recursion/) `GFG`
- [Product of two numbers using Recursion](https://www.geeksforgeeks.org/product-2-numbers-using-recursion/) `GFG`
- [Check maths.lectures.16-math.code.src.com.lectures.05-first-java-program.first-idea-program.src.com.Prime or not](https://www.geeksforgeeks.org/recursive-program-prime-number/) `GFG`
- [easy.lectures.14-recursion.code.src.com.lectures.07-methods.code.src.com.lectures.05-first-java-program.first-idea-program.src.com.Sum of Natural numbers using Recursion](https://www.geeksforgeeks.org/sum-of-natural-numbers-using-recursion/) `GFG`
- [bitwise.lectures.16-math.code.src.com.Power of Two](https://leetcode.com/problems/power-of-two/) `leetcode`
- [bitwise.lectures.16-math.code.src.com.Power of Three](https://leetcode.com/problems/power-of-three/) `leetcode`
- [bitwise.lectures.16-math.code.src.com.Power of Four](https://leetcode.com/problems/power-of-four/) `leetcode`
...
- [Number of easy.lectures.14-recursion.code.src.com.Steps to Reduce a Number to Zero.](https://leetcode.com/problems/number-of-steps-to-reduce-a-number-to-zero/) `leetcode`
...
- [bitwise.lectures.16-math.code.src.com.Power Set of permutations of a string in Lexicographic order.](https://www.geeksforgeeks.org/powet-set-lexicographic-order/) `GFG`

## Medium
- [Combination easy.lectures.14-recursion.code.src.com.lectures.07-methods.code.src.com.lectures.05-first-java-program.first-idea-program.src.com.Sum](https://leetcode.com/problems/combination-sum/) `leetcode`
- [Word Search](https://leetcode.com/problems/word-search/) `leetcode`
- [Target sum](https://leetcode.com/problems/target-sum/) `leetcode`
- [arrays.lectures.14-recursion.code.src.com.Find Kth Bit in Nth Binary String](https://leetcode.com/problems/find-kth-bit-in-nth-binary-string/) `leetcode`
- [K-th Symbol in Grammar](https://leetcode.com/problems/k-th-symbol-in-grammar/) `leetcode`
- [Count Good polymorphism.properties.lectures.17-oop.code.src.com.Numbers](https://leetcode.com/problems/count-good-numbers/) `leetcode`
...
- [Combination easy.lectures.14-recursion.code.src.com.lectures.07-methods.code.src.com.lectures.05-first-java-program.first-idea-program.src.com.Sum II](https://leetcode.com/problems/combination-sum-ii/) `leetcode`
- [combination easy.lectures.14-recursion.code.src.com.lectures.07-methods.code.src.com.lectures.05-first-java-program.first-idea-program.src.com.Sum III](https://leetcode.com/problems/combination-sum-iii/) `leetcode`
...
- [easy.lectures.14-recursion.code.src.com.lectures.06-conditions-loops.code.src.com.Reverse a stack using recursion](https://www.geeksforgeeks.org/reverse-a-stack-using-recursion/) `GFG`
...
- [maths.lectures.16-math.code.src.com.lectures.05-first-java-program.first-idea-program.src.com.Prime numbers after prime P with sum S](https://www.geeksforgeeks.org/prime-numbers-after-prime-p-with-sum-s/) `GFG`
...
## Hard
- [Parsing enumExamples.lectures.17-oop.code.src.com.A Boolean Expression](https://leetcode.com/problems/parsing-a-boolean-expression/) `leetcode`
...
- [enumExamples.lectures.17-oop.code.src.com.Basic lectures.06-conditions-loops.code.src.com.Calculator](https://leetcode.com/problems/basic-calculator/) `leetcode`
...
- [arrays.lectures.14-recursion.code.src.com.Find shortest safe route in a path with landmines](https://www.geeksforgeeks.org/find-shortest-safe-route-in-a-path-with-landmines/) `GFG` `Google`
